...
function Navbar() {
    return (
        <div className="h-20 flex items-center justify-between px-4 bg-[#FFFFFF] fixed w-screen shadow-[#1026490F]/10 shadow-md">
            <div className="flex items-center">
                <img src={logo} alt="Logo" className="w-24 h-6 ml-10" />
            </div>
            <div className="flex items-center">
